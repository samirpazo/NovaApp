...
export default function ConflictsTab() {
  ...
  return (
    <ScrollView
      ...
      contentContainerClassName="mx-auto w-full max-w-3xl gap-3 pb-20 pt-4"
    >
        ...
        <View className="flex-row items-center gap-3 border-y border-border py-4">
          ...
          <View className="gap-0.5">
            ...
            <Text variant="caption">
              No hay decisiones de sincronización pendientes.
            </Text>
          </View>
        </View>
      ) : (
        <Button
          className="min-h-14 justify-start gap-2.5 px-3 py-2.5"
          variant="outline"
